...
# Split-view чатов: страница ?embed=1 открывается во iframe на /chat/
...
if not _default_db_url:
    _default_db_url = f"sqlite:///{(BASE_DIR / 'db.sqlite3').resolve().as_posix()}"
...
CHANNEL_LAYERS = {
    "default": {
        ...
        "CONFIG": {
            "hosts": [
                os.environ.get("REDIS_URL", "redis://yamabiko.proxy.rlwy.net:23593")
            ],
        },
    },
}
